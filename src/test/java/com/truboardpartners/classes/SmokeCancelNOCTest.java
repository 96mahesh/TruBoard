...
public class SmokeCancelNOCTest extends BaseTest {
	...
	public void TestCase_Demo_1() {
		try {
			...
			SmokeCancelNOC nocSmokecancel = new SmokeCancelNOC();
			...
			BaseTest.utilObj.get().getUIUtils().validateObjectPresent(projNOCPage.Noc_Req, projNOCPage.nocrequest, true,
					true);
			BaseTest.utilObj.get().getUIUtils().clickElement(nocSmokecancel.cancelnoc, nocSmokecancel.Cancel_noc);
