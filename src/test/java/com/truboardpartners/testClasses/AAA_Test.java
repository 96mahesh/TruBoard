...
//	}
	...
	public void raiseNOCRequest() throws AWTException {
		...
		//developer_Page.enterPaymentReciveDate();
	...
	public void approvePMC_RFA() throws InterruptedException {
		...
		//pMC_Page.successMsgForApproveNoc();
		login.clickOnlogOut();
	}
	...
	public void approveInvester_RFA() throws InterruptedException {
		...
		//invester_Page.successMsgForApproveNoc();
		login.clickOnlogOut();
	}

	@Test(priority=5,description="Approve Noc Request by DT")
	public void approveDT_RFA() throws InterruptedException, AWTException {
		...
		debenture_Page.clickOnDownload_Btn();
		debenture_Page.uploadDocument();
		debenture_Page.clickOnSubmitBtn();
		login.clickOnlogOut();
	}
	
	@Test(priority = 6, description = "Validation at Developer Page(Approved NOC's Table)")
	public void validationOnApprovedNOC() throws AWTException {
		LoginPage login = new LoginPage();
		Developer_Page developer_Page = new Developer_Page();
		...
		developer_Page.verificationOnApprovedTable();
		login.clickOnlogOut();
