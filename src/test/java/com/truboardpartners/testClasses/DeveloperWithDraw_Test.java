...
public class DeveloperWithDraw_Test extends BaseTest {
	
	@Test(priority = 1, description = "Developer Withdraw NOC request")
	public void withDrawNOCRequest() throws AWTException {
		...
		developer_Page.selectValueFromeSelectFieldPendingTable();
		developer_Page.enterValueInSearchForWithdrawPendingTable();
		developer_Page.verificationOnPendingTable();
		developer_Page.clickOnWithdrawBtn();
		developer_Page.clickOnYseBtnWithdraw();
		developer_Page.withdrawSuccessMessage();
	}
