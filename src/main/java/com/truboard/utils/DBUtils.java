...
public class DBUtils {
	...
	public LinkedHashMap<Integer, HashMap<String, String>> getAllSQLRecords(String SQL){
		...
		try {
			...
			e.printStackTrace();
			BaseTest.utilObj.get().getAssertManager().sAssertException("Exception occurred in getAllSQLRecords for SQL:"+SQL+".Exception:"+e.getMessage(), false);
		}
	...
	public String getSingleDataFromSQLQuery(String SQL, String colName) {
		...
		try {
			...
			e.printStackTrace();
			BaseTest.utilObj.get().getAssertManager().sAssertException("Exception occurred in getSingleDataFromSQLQuery for SQL:"+SQL+" and column name:"+colName+".Exception:"+e.getMessage(), false);
		}
