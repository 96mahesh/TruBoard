...
public class DataLoaders {
	...
	public String getTestData(ThreadLocal<LinkedHashMap<String, LinkedHashMap<String, String>>> allTestData, String objName, String...testName) {
		...
		try {
			...
			BaseTest.utilObj.get().getAssertManager().sAssertException("Failing the test as not able to return data for field:"+objName+".Exception:"+e.getMessage(), false, true);
		}		
		return returnVal;
	}
